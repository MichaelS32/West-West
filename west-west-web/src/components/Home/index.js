    ...
    return (
        <section>
            <div className='article'>
                ...
                <img className='picture' style={{ width: '100%' }} src={hero} alt='San Antonio Skyline' />
                </div>
                <Box className='hover'> 
